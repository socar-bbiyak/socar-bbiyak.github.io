...
- Kubernetes, Airflow 등과 같은 도구를 쏘카에서는 어떻게 온보딩하고 활용하는지 궁금한 사람

## 입사 지원 배경

 쏘카 데이터 엔지니어링팀에 합류하기 전까지, 저는 의료 기기 스타트업에서 데이터 엔지니어로 일하며, 
 적은 데이터의 가시성을 높이고 이를 통해 의사결정을 할 수 있는 환경을 구축하는 데 주력해 왔습니다. 
 데이터 파이프라인을 설계하고 개발 하면서, 조직이 데이터를 보다 잘 활용할 수 있도록 돕는 일이 주요 업무였습니다. 
 하지만 이러한 경험 속에서 아쉬움도 남아 있었습니다.
...
입사 과정에 대한 자세한 내용은  [쏘카 신입 데이터 엔지니어 디니의 4개월 회고](https://tech.socarcorp.kr/data/2021/12/28/data-engineering-team-onboarding.html) 와 크게 다르지 않습니다. 
 다만 제 경우에는 1차, 2차 모두 `어떤 문제에 대해서 어떻게 설계할 것인가`라는 토론 형식의 면접이 진행되었습니다. 이 과정은 쏘카가 문제를 정의하고 해결하는 방식의 일면을 경험할 수 있는 기회였습니다. 문제를 정의하고, 함께 토론하며 해결책을 모색하는 방식은 상당히 즐겁고 인상 깊었습니다. 이러한 경험들은 제가 입사를 결심하는 데 큰 영향을 미쳤습니다.
...
![image5.png](/img/2025-01-16-dataengineer-onboarding/image5.png)
 ...
 온보딩 과제는 익숙한 것들도 있었고 처음 접하는 것들도 있었습니다. 작게나마 쏘카에서 Data Engineer가 사용하는 기술 스택을 빠르게 경험 해 볼 좋은 기회 였다고 생각합니다. 과제는 처음에는 어렵게 느껴졌지만, 하나씩 차근차근 공부해 나가니 결국 모두 해결할 수 있었습니다.
